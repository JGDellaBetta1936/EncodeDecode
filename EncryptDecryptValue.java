...
public class EncryptDecryptValue {
	...
	public static void main (String [] args) {
		...
		String rtnValue = edv1.encodeTheValue("Amin");
		log.info("Original parse->" + rtnValue );
		String rtnCoded = edv1.decodeTheValue(rtnValue);
		log.info("After Encoding recived back->" + rtnCoded );
	}
